package com.kseniyaa.loftcoin.utils;
...
public class CurrencyFormatter {
    ...
    public CurrencyFormatter() {
        DecimalFormatSymbols unusaulSymbols = new DecimalFormatSymbols();
        unusaulSymbols.setGroupingSeparator(' ');
        unusaulSymbols.setDecimalSeparator('.');

        decimalFormat = new DecimalFormat();
        decimalFormat.setDecimalFormatSymbols(unusaulSymbols);
    }
